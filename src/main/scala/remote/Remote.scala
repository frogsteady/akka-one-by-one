...
object MembersService extends App {
  val config = ConfigFactory.load("remote").getConfig("MembersService")
...
object MemberServiceLookup extends App {
  ...
  val config = ConfigFactory.load("remote").getConfig("MemberServiceLookup")
...
object MembersServiceRemoteCreation extends App {
  ...
  val config = ConfigFactory.load("remote").getConfig("MembersServiceRemoteCreation")
